...
// EXPRESS: 13 preguntas con porcentajes fijos del documento
// 0%, 5%, 10%, 20%, 30%, 40%, 50%, 60%, 65%, 70%, 75%, 80%, 90%
...
// PROFESSIONAL: 20 preguntas con porcentajes fijos del documento
